/* ============================================================
   TRADUCTIONS — ajoute ou modifie les textes ici.
...
const translations = {
  fr: {
    ...
    "other.p1.desc": "Roguelike développé dans le cadre d'une Game Jam, où le joueur doit éliminer un maximum d'ennemis afin de gagner de l'argent à dépenser dans le casino pour obtenir des améliorations.",
     "other.p2.desc": "Earniverse est un Metaverse en monde ouvert, axé sur l’exploration et la construction, et compatible avec la réalité virtuelle (VR). Lors de mon stage, j’ai été chargé de concevoir et d’intégrer des pièges au sein du système de construction existant.",
    ...
    "about.stat3": "En programmation",
    "about.stat4num": "Passionné",
    "about.stat4": "Par les systèmes performants",

    "skills.eyebrow": "compétences",
    "skills.title": "Langages et outils que j'utilise",
    "skills.langages": "Langages",
    "skills.outils": "Outils & bibliothèques",
  ...
  en: {
   ...
   "year2.p4.desc":"A single-player arena shooter where the goal is to survive every wave of enemies and defeat the final boss.",
    ...
    "about.stat3": "In programming",
    "about.stat4num": "Passionate",
    "about.stat4": "About performant systems",

    "skills.eyebrow": "skills",
    "skills.title": "Languages and tools I use",
    "skills.langages": "Languages",
    "skills.outils": "Tools & libraries",
